...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* INICIO + SIMULADOR */}
      <div id="inicio" className="pt-24 min-h-screen bg-gray-50">
        <div id="simulador" className="max-w-xl mx-auto p-4 bg-white rounded-xl shadow-md">
